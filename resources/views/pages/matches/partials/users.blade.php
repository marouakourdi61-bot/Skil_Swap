        ...
        <div class="md:w-1/2 p-10 flex flex-col">
            ...
            <div class="flex flex-wrap gap-2 mb-auto">
                ...
                @foreach($user->skills as $skill)
                    <span
                        class="bg-surface-container-high text-on-surface px-4 py-1.5 rounded-full font-label text-[11px] font-bold uppercase tracking-wider">
            ...
            <div class="mt-10 flex items-center gap-6">
                <form method="POST" action="{{ route('exchange.send', $user->id) }}">
                    @csrf

                    <button type="submit"
                        class="bg-primary text-on-primary px-10 py-4 rounded-full font-headline font-bold text-base shadow-sm">
                        Contact
                    </button>
                </form>

                <button
                    class="w-14 h-14 rounded-full border border-outline-variant/30 flex items-center justify-center text-primary">
